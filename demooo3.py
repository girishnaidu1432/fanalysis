        ...
        if required_columns.issubset(set(df.columns)):
            ...
            with tab2:
                ...
                predefined_questions = [
                    ...
                    "How can we fix overlapping elements in the Total Bonus Distribution Graph?",
                    "What improvements can be made to the Gender-Based Bonus Distribution analysis?",
                    "Show role-wise Gross Earnings for better comparison.",
                    "Why do gender distribution counts differ in different scenarios?",
                    "Provide a detailed gender-based bonus analysis using consistent calculations.",
                    "Who are the top earners, including all commission components?",
                    "Display top earners with correct serial numbering starting from 1.",
                    "How is the Total Bonus split across different commission types?",
                    "Which columns in the analysis are irrelevant and should be removed?",
                    "Does the 'Gross Earnings by Country' metric add value if data is from a single country?",
                    "Show a role-wise Gross Earnings graph instead of less relevant metrics.",
                    "Analyze manager-wise bonus distribution for fair allocation.",
                    "Explore gender-based discrepancies in bonuses.",
                    "Visualize top earners and their contributions to Gross Earnings.",
                    "Verify the sum of individual bonuses against the data.",
                    "How do Total Bonus calculations compare with the raw data?",
